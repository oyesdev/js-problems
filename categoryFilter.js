...
function test(data) {
  ...
  for (let i = 0; i < category.length; i++) {
    ...
    if (element.parent.parent === null) {
      if (obj.hasOwnProperty(element.parent.name)) {
        let subCat = {
          name: element.name,
          id: element.id,
          image_url: element.image_url,
        };
        const lookforSubCat = obj[element.parent.name]["children"].find(
          (ele) => ele.id === subCat.id
        );
        !lookforSubCat && obj[element.parent.name]["children"].push(subCat);
      } else {
        let subCat = {
          name: element.name,
          id: element.id,
      ...
      if (obj.hasOwnProperty(element.parent.parent.name)) {
        let subCat = {
          name: element.parent.name,
          id: element.parent.id,
          image_url: element.parent.image_url,
        };
        const lookforSubCat = obj[element.parent.parent.name]["children"].find(
          (ele) => ele.id === subCat.id
        );
        !lookforSubCat &&
          obj[element.parent.parent.name]["children"].push(subCat);
      } else {
        let subCat = {
          name: element.parent.name,
          id: element.parent.id,
        ...
        obj[element.parent.parent.name] = {
          name: element.parent.parent.name,
          id: element.parent.parent.id,
          image_url: element.parent.parent.image_url,
          children: [subCat],
        };
      }
    }
...
function test2(data) {
  ...
  for (let i = 0; i < category.length; i++) {
    const element = category[i];
    if (element.parent.parent === null) {
      const { name, id, image_url, parent } = element;
      let subCat = {
        name: name,
        id: id,
        image_url: image_url,
      ...
      const { name, id, image_url, parent } = element.parent;
      let subCat = {
        name: name,
        id: id,
        image_url: image_url,
